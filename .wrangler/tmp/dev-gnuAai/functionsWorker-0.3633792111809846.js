...
// ../.wrangler/tmp/pages-QHJweq/functionsWorker-0.3633792111809846.mjs
...
async function onRequest2(context) {
  ...
  if (url.pathname.startsWith("/assets/") || /\.(css|js|mjs|map|json|svg|png|jpg|jpeg|gif|webp|ico|woff2?|ttf|mp4|webm)$/i.test(url.pathname)) {
    return next();
  }
  ...
  const EXTRA = isHome ? `<!-- Optional homepage-only font preloads -->
...
// .wrangler/tmp/bundle-E43aAt/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-E43aAt/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.3633792111809846.js.map
